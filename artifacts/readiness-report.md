...
| CR-04 | VERIFIED_LOCAL | Evidence register | Source register contains 13 classified evidence rows. Evidence: `artifacts/source-register.csv`, `02-research/snapshots`. |
...
| CR-07 | VERIFIED_LOCAL | Three-minute-or-less walkthrough | Demo container exists and its deterministic slide source covers the required narrative beats and disclaimer. Evidence: `outputs/demo.mp4`, `04-deliverables/demo-storyboard.md`, `work/build_demo.py`. |
