...
<head>
  ...
  <link rel="canonical" href="https://mara.rahilbhavan.com/">
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://mara.rahilbhavan.com/">
  ...
  <meta property="og:image" content="https://mara.rahilbhavan.com/social-card.png">
...
<header>
  <div class="site-nav"><a class="brand" href="#main-content" aria-label="MARA credit decision, skip to content"><span class="brand-mark" aria-hidden="true">MC</span><span>MARA <span class="brand-light">/ Credit case</span></span></a><span class="nav-context">Independent credit analysis</span><a class="nav-document" href="committee-packet.pdf">Committee packet <span aria-hidden="true">↗</span></a></div>
  <div class="hero"><span class="hero-eyebrow">MARA-CR-001 · Decision view</span><h1>Credit decision, traced to the evidence.</h1><p>Hypothetical $5 million secured revolver, examined through its limits, collateral, conditions, and stress cases.</p><div class="hero-actions"><a class="hero-primary" href="#decisionSummary">Explore the decision <span aria-hidden="true">↗</span></a><a class="hero-secondary" href="credit-memo.pdf">Read the credit memo</a></div></div>
</header>
